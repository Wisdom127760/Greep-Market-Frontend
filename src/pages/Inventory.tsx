...
export const Inventory: React.FC = () => {
  const { products, inventoryAlerts, updateProduct, refreshDashboard } = useApp();
  ...
  const getStockStatus = (product: any) => {
    if (product.stock_quantity === 0) {
      return { status: 'out_of_stock', color: 'text-red-600', bgColor: 'bg-red-100', label: 'Out of Stock' };
    } else if (product.stock_quantity <= product.min_stock_level) {
      return { status: 'low_stock', color: 'text-yellow-600', bgColor: 'bg-yellow-100', label: 'Low Stock' };
    } else {
      return { status: 'normal', color: 'text-green-600', bgColor: 'bg-green-100', label: 'In Stock' };
    }
  };
      ...
      <div className="max-w-7xl mx-auto space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Monitor stock levels and manage inventory efficiently</p>
                  </div>
                </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          <Card className="text-center p-4 hover:shadow-md transition-shadow duration-200">
            ...
            <h3 className="text-xs font-medium text-gray-500 mb-1">Total Products</h3>
          ...
          <Card className="text-center p-4 hover:shadow-md transition-shadow duration-200">
            ...
            <h3 className="text-xs font-medium text-gray-500 mb-1">In Stock</h3>
          ...
          <Card className="text-center p-4 hover:shadow-md transition-shadow duration-200">
            ...
            <h3 className="text-xs font-medium text-gray-500 mb-1">Low Stock</h3>
            <p className="text-lg font-semibold text-gray-800">
          ...
          <Card className="text-center p-4 hover:shadow-md transition-shadow duration-200">
            ...
            <h3 className="text-xs font-medium text-gray-500 mb-1">Out of Stock</h3>
            <p className="text-lg font-semibold text-gray-800">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6">
            ...
            <div className="space-y-3">
              {inventoryAlerts.map(alert => (
                <div key={alert._id} className="flex items-center justify-between p-4 bg-red-50 rounded-xl border border-red-200 hover:bg-red-100 transition-colors duration-200">
                  <div>
        ...
        {filteredProducts.length > 0 ? (
          <div className="space-y-4">
            {filteredProducts.map(product => {
              ...
              return (
                <div key={product._id} className="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 hover:shadow-xl transition-shadow duration-200">
